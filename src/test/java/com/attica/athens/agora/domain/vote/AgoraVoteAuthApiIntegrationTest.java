...
public class AgoraVoteAuthApiIntegrationTest extends IntegrationTestSupport {
    ...
    class AgoraVoteTest {
        ...
        @Test
        @DisplayName("투표하는 유저의 ID가 존재하지 않을 경우 예외 발생")
        @Sql(scripts = {
                "/sql/enter-agora-members.sql",
                "/sql/agora-status-closed.sql"
        })
        ...
        @Test
        @DisplayName("아고라가 존재하지 않을 경우 에외 발생")
        @WithMockCustomUser
        ...
        @Test
        @DisplayName("투표할때 아고라의 상태가 RUNNUING이거나 QUEUED일 경우 예외 발생")
        @WithMockCustomUser
        ...
        @Test
        @DisplayName("중복으로 찬반 투표 요청이 들어올 경우 예외 발생")
        @Sql(scripts = {
                "/sql/enter-agora-members.sql",
                "/sql/agora-status-closed.sql",
        ...
        @Test
        @DisplayName("투표를 하지 않았을 때 예외 발생")
        @Sql(scripts = {
                "/sql/enter-agora-members.sql",
                "/sql/agora-status-closed.sql"
        })
        ...
        @Test
        @DisplayName("Agora 종료시간과 투표 api 요청 시간 차이가 20초가 넘어간다면 예외 발생")
        @Sql(scripts = {
                "/sql/enter-agora-members.sql",
