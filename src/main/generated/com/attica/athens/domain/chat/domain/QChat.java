...
public class QChat extends EntityPathBase<Chat> {
    ...
    public final com.attica.athens.domain.agoraUser.domain.QAgoraUser agoraUser;
    ...
    public QChat(Class<? extends Chat> type, PathMetadata metadata, PathInits inits) {
        ...
        this.agoraUser = inits.isInitialized("agoraUser") ? new com.attica.athens.domain.agoraUser.domain.QAgoraUser(forProperty("agoraUser"), inits.get("agoraUser")) : null;
    }
