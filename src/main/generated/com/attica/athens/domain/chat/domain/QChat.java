...
public class QChat extends EntityPathBase<Chat> {
    ...
    public final com.attica.athens.domain.agoraUser.domain.QAgoraUser user;
    ...
    public QChat(Class<? extends Chat> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.attica.athens.domain.agoraUser.domain.QAgoraUser(forProperty("user"), inits.get("user")) : null;
    }
